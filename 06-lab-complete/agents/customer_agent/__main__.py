...
from agents.common.registry_client import register
from agents.customer_agent.agent_executor import CustomerAgentExecutor
...
PORT = int(os.getenv("CUSTOMER_AGENT_PORT", "10100"))
